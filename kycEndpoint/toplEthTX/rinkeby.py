...
class Rinkeby:
    def __init__(self):
        ...
        self.iconiq_data_pipe_addr = '0xeb828a191f4911d0e371855450ed5d5d057b06b1'
    ...
    def add_to_whitelist(self, user_addr):
        ...
        rawTX = _contract.functions.add_to_whitelist(self.w3.toChecksumAddress(user_addr)).buildTransaction(get_tx_params(toplAcct))
    ...
    def set_iconiq_token_allotment(self, addr_):
        ...
        # create various stages of the transaction
        rawTX =  _contract.functions.set_iconiq_token_amount(self.w3.toChecksumAddress(addr_), 18000000).buildTransaction(get_tx_params(toplAcct))
        signTX = toplAcct.signTransaction(rawTX)
